...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center text-white" style="background-color: #2b2b2c; border: 1px solid #141414; font-weight: bolder">{{ __('Register') }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('user_role') is-invalid @enderror" id="user_role" name="user_role" >
                                    ...
                                    <option value="Activity_developer">Activity developer</option>
